...
TEST_CASE("GameplayInstance judges tap, combo, score and auto-miss", "[instances][GameplayInstance]") {
...
TEST_CASE("GameplayInstance resolves hold by tail timing and ignores release after resolve",
          "[instances][GameplayInstance]") {
    RuntimeConfigGuard cfg;
    RuntimeConfigs::chartOffsetMs  = 0;
    RuntimeConfigs::chartPreloadMs = 3000;
    RuntimeConfigs::keyBindings    = {65};
...
TEST_CASE("GameplayInstance marks hold miss on early release and head timeout", "[instances][GameplayInstance]") {
    RuntimeConfigGuard cfg;
    RuntimeConfigs::chartOffsetMs  = 0;
    RuntimeConfigs::chartPreloadMs = 3000;
    RuntimeConfigs::keyBindings    = {65};
...
TEST_CASE("GameplayInstance applies overlap priority and chart end settlement delay", "[instances][GameplayInstance]") {
    RuntimeConfigGuard cfg;
    RuntimeConfigs::chartOffsetMs  = 0;
    RuntimeConfigs::chartPreloadMs = 3000;
    RuntimeConfigs::keyBindings    = {65};
...
TEST_CASE("GameplayInstance exposes dual clock control for audio/chart timelines", "[instances][GameplayInstance]") {
    RuntimeConfigGuard cfg;
    RuntimeConfigs::chartOffsetMs  = 0;
    RuntimeConfigs::chartPreloadMs = 3000;
    RuntimeConfigs::keyBindings    = {65};
