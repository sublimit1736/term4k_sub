...
TEST_CASE("LiteDBUtils hex encode/decode roundtrip and invalid input", "[utils][LiteDBUtils]") {
...
TEST_CASE("LiteDBUtils hash outputs are deterministic with SHA-256 length", "[utils][LiteDBUtils]") {
...
TEST_CASE("LiteDBUtils key setup, xor obfuscation and AES roundtrip", "[utils][LiteDBUtils]") {
