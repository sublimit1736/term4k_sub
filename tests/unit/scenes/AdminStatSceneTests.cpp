...
"AdminStatScene exposes per-user stats for verified and all records"
,
"[instances][AdminStatScene]"
)
 {
    ...
    REQUIRE(RecordStore::addRecord("1000 chart_a song alice 900000 90.0 100 300"));
    REQUIRE(RecordStore::addRecord("1001 chart_a song bob 880000 80.0 200 250"));
...
"AdminStatScene keeps stable order for equal timestamps and provides fallback chart metadata"
,
"[instances][AdminStatScene]"
)
 {
    ...
    REQUIRE(RecordStore::addRecord("1000 chart_a song alice 123456 90.0 500 10"));
    REQUIRE(RecordStore::addRecord("1000 chart_missing song alice 654321 91.0 500 20"));
...
"AdminStatScene keeps maxCombo at 0 for legacy record format"
,
"[instances][AdminStatScene]"
)
 {
    ...
    REQUIRE(RecordStore::addRecord("1000 chart_a song alice 900000 90.0 100"));
